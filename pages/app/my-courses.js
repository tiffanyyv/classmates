...
export default function MyCoursesPage() {
  ...
  const [userInfo, setUserInfo] = useState({ userType: '', userID: '51', first_name: '', last_name: '', avatar_photo: '' })

  useEffect(() => {
    getUserInfo(userInfo.userID)
      .then(res => setUserInfo({ userType: res.account_type, userID: res.id, first_name: res.name.first_name, last_name: res.name.last_name, avatar_photo: res.photo }))
